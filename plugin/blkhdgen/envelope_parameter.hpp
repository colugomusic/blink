...
public:
	...
	ml::DSPVector get_mod_values(Traverser* traverser, const blkhdgen_EnvelopeData* data) const;
	float get_mod_value(Traverser* traverser, const blkhdgen_EnvelopeData* data) const;
	float get_mod_value(const blkhdgen_EnvelopeData* data, float position, bool reset) const;
...
inline ml::DSPVector EnvelopeParameter::get_mod_values(Traverser* traverser, const blkhdgen_EnvelopeData* data) const
{
...
inline float EnvelopeParameter::get_mod_value(Traverser* traverser, const blkhdgen_EnvelopeData* data) const
{
	if (!data) return default_value_;
	if (data->points.count < 1) return default_value_;
...
inline float EnvelopeParameter::get_mod_value(const blkhdgen_EnvelopeData* data, float position, bool reset) const
{
