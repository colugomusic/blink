...
inline const blkhdgen_SampleInfo* Sampler::get_sample_info() const
{
	return sample_data_.get_info();
}

inline blkhdgen_FrameCount Sampler::get_sample_data(blkhdgen_ChannelCount channel, blkhdgen_Index index, blkhdgen_FrameCount size, float* buffer) const
{
...
inline ml::DSPVector Sampler::read_sample_frames_interp(blkhdgen_ChannelCount channel, const ml::DSPVector& pos, bool loop)
{
